...
<div class="container" id="main-form">
    ...
    <div id="weather">
        <?php
            ...
            else if($weather=='' && isset($_GET['city']) ){
                echo '<div class="alert alert-info" role="alert">Sorry weather not found for the selected city '.$_GET['city'].'</div>';
...
<script type="text/javascript" src="javascript/weather-teller.js">
</script>
</body>
</html>